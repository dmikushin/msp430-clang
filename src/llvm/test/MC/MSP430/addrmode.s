...
; CHECK: mov r7, @r15          ; encoding: [0x8f,0x47,0x00,0x00]
; CHECK: mov 12(r15), @r7      ; encoding: [0x97,0x4f,0x0c,0x00,0x00,0x00]
...
; CHECK: call #disp            ; encoding: [0xb0,0x12,A,A]
  ...
  bit #-1, 2(r7)    ; CHECK: bit #-1, 2(r7)    ; encoding: [0xb7,0xbf,0x02,0x00]
  bit #42, 2(r7)    ; CHECK: bit #42, 2(r7)    ; encoding: [0xa7,0xba,0x02,0x00]
